				...
				<legend>필수입력사항</legend>
					...
					<div>
						<label>* 이름</label> <br> <input class="form-control" value="${user.uname}"
							name="uname" placeholder="이름" disabled>
					</div>
					...
					<div>
						<label>주소</label>
						<p>우편번호를 먼저 찾아주세요.</p>
						<label><input type="text" class="form-control" id="postcode" name="postcode" placeholder="우편번호"></label>
						<input type="button" onclick="daumPostcode()" value="우편번호 찾기"><br>
						<input type="text" class="form-control" name="addr" id="addr" placeholder="주소" value="${user.addr}"><br>
						<input type="text" class="form-control" name="detailAddr" id="detailAddr" placeholder="상세주소" value="${user.detailAddr}">
