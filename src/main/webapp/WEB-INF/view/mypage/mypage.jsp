				...
				<div class="row viewcard-group">
					...
					<div class="col-lg viewcard mypage-card" id="card2">
						<div class="mypage-card-left">
							...
							<div class="emojitxt">
								<img src="" id="card2-emoji" /> <span id="card2-emoji-txt"></span>
							</div>
				...
				<div class="mypage-calendar-flex">
					...
					<div class="mate-top-title">
						<div class="mypage-calendar-top-start">
							<button class="btn fa-solid fa-solid fa-angles-left"
								id="year-left-btn"></button>
							...
							<button class="btn fa-solid fa-solid fa-angles-right"
								id="year-right-btn"></button>
						</div>
						<i class="fa-solid fa-list-ul calendar-list-icon"
							onclick="location.href='/mypage/cash/list'"></i>
					</div>
					<div>
						<ul class="weekdays">
							<li SUNDAY>일</li>
						...
						<ol class="day-grid">
							...
							<c:forEach var="info" items="${calendar.infoList }">
								<li ${info.value.type} CASH-DATE="${info.value.date}">
