        ...
        <div class="writebox flex-lg-row">
          ...
          <div class="inputbox">
            <form id="mateform" class="inputbox">
              <input class="form-control text input-text empty-text" type="date" name="cashDate" value="${rec.cashDate}" id="date" disabled />
              <input class="form-control text input-text" type="number" name="amount" value="${rec.amount}" placeholder="금액*" disabled />
              <input class="form-control text input-text" type="text" name="cashContent" value="${rec.cashContent}" placeholder="내역*" disabled />
              <textarea class="form-control" name="memo" cols="30" rows="10" placeholder="메모"></textarea>
            </form>
          </div>
        </div>
      </section>
