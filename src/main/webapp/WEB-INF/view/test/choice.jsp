...
<body>
	...
	<div class="container-nonaside-sm">
		<div class="question-box">
			<div class="question">
				<h3>${user.nickname}님,<br> 오늘 참여한 챌린지를<br> 선택해주세요!
				</h3>
			</div>
			<c:forEach items="${challenge}" var="c">
				<button class="btn btn-gray choice" type="button" name="op"
					...
					<c:if test="${c.cid eq 1}"><img src="/emoji/bus.png" height="50"></c:if>
					<c:if test="${c.cid eq 2}"><img src="/emoji/fork.png" height="50"></c:if>
					<c:if test="${c.cid eq 3}"><img src="/emoji/hot-beverage_2615.png" height="50"></c:if>
					${c.cname}<br>
