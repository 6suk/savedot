          ...
          <div class="inputbox">
            ...
            <form id="mateform" class="inputbox">
              ...
              <div class="d-flex gap-2">
                <input class="form-control text" type="number" name="price1" placeholder="구매가*" />
                <input class="form-control text" type="number" name="price2" placeholder="판매가*" />
              </div>
              <textarea class="form-control" name="content" cols="30" rows="10" placeholder="본문"></textarea>
              <div class="d-flex">
                <input type="text" class="form-control text" id="sample3_address" placeholder="주소" readonly/>
                <input type="button" class="btn btn-border" onclick="sample3_execDaumPostcode()" value="주소찾기" />
              </div>
              <div
                id="wrap"
